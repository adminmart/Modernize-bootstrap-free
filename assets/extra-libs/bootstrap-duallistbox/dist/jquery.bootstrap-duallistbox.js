...
(function ($, window, document, undefined) {
  ...
  var pluginName = "bootstrapDualListbox",
    defaults = {
      ...
      infoTextFiltered:
        '<span class="label label-warning">Filtered</span> {0} from {1}', // when not all of the options are visible due to the filter
  ...
  function refreshInfo(dualListbox) {
    ...
    var visible1 = dualListbox.elements.select1.find("option").length,
      ...
      all1 =
        dualListbox.element.find("option").length -
    ...
    if (all1 === 0) {
      ...
      content = formatString(dualListbox.settings.infoTextFiltered, [
        visible1,
        all1,
      ]);
    }
    ...
    dualListbox.elements.box1.toggleClass(
      "filtered",
      !(visible1 === all1 || all1 === 0)
    );
    ...
    dualListbox.elements.box2.toggleClass(
      "filtered",
      !(visible2 === all2 || all2 === 0)
    );
  }
  ...
  function refreshSelects(dualListbox) {
    ...
    dualListbox.element.find("option").each(function (index, item) {
      ...
      if ($item.prop("selected")) {
        dualListbox.selectedElements++;
        dualListbox.elements.select2.append(
          $item.clone(true).prop("selected", $item.data("_selected"))
        );
      } else {
        dualListbox.elements.select1.append(
          $item.clone(true).prop("selected", $item.data("_selected"))
        );
      }
    });
  ...
  function filter(dualListbox, selectIndex) {
    ...
    options.each(function (index, item) {
      ...
      if (
        ...
        isFiltered = false;
        dualListbox.elements["select" + selectIndex].append(
          $item.clone(true).prop("selected", $item.data("_selected"))
        );
      }
      allOptions
        .eq($item.data("original-index"))
  ...
  function saveSelections(dualListbox, selectIndex) {
    ...
    dualListbox.elements["select" + selectIndex]
      .find("option")
  ...
  function move(dualListbox) {
    if (
      dualListbox.settings.preserveSelectionOnMove === "all" &&
      !dualListbox.settings.moveOnSelect
    ) {
      saveSelections(dualListbox, 1);
      saveSelections(dualListbox, 2);
    } else if (
      dualListbox.settings.preserveSelectionOnMove === "moved" &&
      !dualListbox.settings.moveOnSelect
    ) {
      saveSelections(dualListbox, 1);
    }
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      var select1Id =
          "bootstrap-duallistbox-nonselected-list_" + this.originalSelectName,
        select2Id =
          "bootstrap-duallistbox-selected-list_" + this.originalSelectName;
    ...
    setHelperSelectNamePostfix: function (value, refresh) {
      ...
      if (value) {
        this.elements.select1.attr(
          "name",
          this.originalSelectName + value + "1"
        );
        this.elements.select2.attr(
          "name",
          this.originalSelectName + value + "2"
        );
      } else {
  ...
  $.fn[pluginName] = function (options) {
    ...
    if (options === undefined || typeof options === "object") {
      return this.each(function () {
        ...
        if (!$(this).is("select")) {
          ...
          $.data(
            this,
            "plugin_" + pluginName,
            new BootstrapDualListbox(this, options)
          );
        }
      });
      ...
      this.each(function () {
        ...
        if (
          instance instanceof BootstrapDualListbox &&
