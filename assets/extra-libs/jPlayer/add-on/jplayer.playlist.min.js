  ...
  (jPlayerPlaylist = function (b, c, d) {
    ...
    (this.current = 0),
      ...
      a(this.cssSelector.jPlayer).bind(a.jPlayer.event.resize, function (b) {
        b.jPlayer.options.fullScreen
          ? a(e.cssSelector.details).show()
          : a(e.cssSelector.details).hide();
      }),
      ...
      a(this.cssSelector.shuffle).click(function (b) {
        b.preventDefault(),
          e.shuffle(
            e.shuffled &&
              a(e.cssSelector.jPlayer).jPlayer("option", "useStateClassSkin")
              ? !1
              : !0
          ),
          e.blur(this);
      }),
      a(this.cssSelector.shuffleOff)
        .click(function (a) {
    ...
    (jPlayerPlaylist.prototype = {
        ...
        if (b && !a.isFunction(b))
          a(this.cssSelector.playlist + " ul").empty(),
            a.each(this.playlist, function (b) {
              a(c.cssSelector.playlist + " ul").append(
                c._createListItem(c.playlist[b])
              );
            }),
            this._updateControls();
        else {
          var d = a(this.cssSelector.playlist + " ul").children().length
            ? this.options.playlistOptions.displayTime
            : 0;
          a(this.cssSelector.playlist + " ul").slideUp(d, function () {
            var d = a(this);
            a(this).empty(),
              a.each(c.playlist, function (a) {
      ...
      _createListItem: function (b) {
        ...
        return (
          (d +=
            ...
            b.title +
            (b.artist
              ? " <span class='jp-artist'>by " + b.artist + "</span>"
              : "") +
            "</a>"),
          (d += "</div></li>")
        );
        ...
        a(this.cssSelector.playlist)
          ...
          .on(
            ...
            function (c) {
              ...
              b.current !== d
                ? b.play(d)
                : a(b.cssSelector.jPlayer).jPlayer("play"),
                b.blur(this);
            }
          ),
          a(this.cssSelector.playlist)
              ...
              function (c) {
                c.preventDefault(),
                  a(this)
                    .parent()
                    .parent()
                    .find("." + b.options.playlistOptions.itemClass)
                    .click(),
                  b.blur(this);
              }
            ),
      ...
      _updateControls: function () {
        this.options.playlistOptions.enableRemoveControls
          ...
          this.shuffled
            ...
            : a(this.cssSelector.jPlayer).jPlayer(
                "removeStateClass",
                "shuffled"
              ),
          a(this.cssSelector.shuffle).length &&
            a(this.cssSelector.shuffleOff).length &&
            (this.shuffled
      ...
      _highlight: function (c) {
        this.playlist.length &&
          c !== b &&
          (a(this.cssSelector.playlist + " .jp-playlist-current").removeClass(
            "jp-playlist-current"
          ),
          a(this.cssSelector.playlist + " li:nth-child(" + (c + 1) + ")")
      ...
      add: function (b, c) {
        a(this.cssSelector.playlist + " ul")
          .append(this._createListItem(b))
          .find("li:last-child")
          .hide()
      ...
      remove: function (c) {
        ...
        return c === b
          ...
          : this.removing
          ? !1
          : ((c = 0 > c ? d.original.length + c : c),
            c >= 0 &&
              c < this.playlist.length &&
              ((this.removing = !0),
              a(
                this.cssSelector.playlist + " li:nth-child(" + (c + 1) + ")"
              ).slideUp(this.options.playlistOptions.removeTime, function () {
                if ((a(this).remove(), d.shuffled)) {
                  var b = d.playlist[c];
                  a.each(d.original, function (a) {
                    return d.original[a] === b
                      ? (d.original.splice(a, 1), !1)
                      : void 0;
                  }),
      ...
      play: function (c) {
        (c = 0 > c ? this.original.length + c : c),
          c >= 0 && c < this.playlist.length
            ? this.playlist.length &&
              (this.select(c), a(this.cssSelector.jPlayer).jPlayer("play"))
            : c === b && a(this.cssSelector.jPlayer).jPlayer("play");
      },
      pause: function () {
      ...
      shuffle: function (c, d) {
        ...
        c === b && (c = !this.shuffled),
          (c || c !== this.shuffled) &&
            a(this.cssSelector.playlist + " ul").slideUp(
              this.options.playlistOptions.shuffleTime,
              function () {
                (e.shuffled = c),
                  c
                    ? e.playlist.sort(function () {
                        return 0.5 - Math.random();
                      })
                    : e._originalPlaylist(),
                  e._refresh(!0),
                  d || !a(e.cssSelector.jPlayer).data("jPlayer").status.paused
                    ? e.play(0)
                    : e.select(0),
      ...
      blur: function (b) {
        a(this.cssSelector.jPlayer).jPlayer("option", "autoBlur") &&
          a(b).blur();
      },
    });
})(jQuery);
