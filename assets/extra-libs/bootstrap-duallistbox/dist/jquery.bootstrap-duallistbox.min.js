...
!(function (a, b, c, d) {
  ...
  function g(b) {
    b.element.find("option").each(function (c, d) {
      var e = a(d);
      "undefined" == typeof e.data("original-index") &&
        e.data("original-index", b.elementCount++),
  ...
  function h(b, c, d) {
    b.element.find("option").each(function (e, f) {
      var g = a(f);
      g.data("original-index") === c &&
        (g.prop("selected", d),
        d
          ? (g.attr("data-sortindex", b.sortIndex), b.sortIndex++)
          : g.removeAttr("data-sortindex"));
    });
  }
  function i(a, b) {
  ...
  function j(a) {
    if (a.settings.infoText) {
      ...
      (f =
        0 === d
          ? a.settings.infoTextEmpty
          : b === d
          ? i(a.settings.infoText, [b, d])
          : i(a.settings.infoTextFiltered, [b, d])),
        a.elements.info1.html(f),
        a.elements.box1.toggleClass("filtered", !(b === d || 0 === d)),
        (f =
          0 === e
            ? a.settings.infoTextEmpty
            : c === e
        ...
        a.elements.info2.html(f),
        a.elements.box2.toggleClass("filtered", !(c === e || 0 === e));
    }
  }
  function k(b) {
    (b.selectedElements = 0),
      b.elements.select1.empty(),
      b.elements.select2.empty(),
      b.element.find("option").each(function (c, d) {
        var e = a(d);
        e.prop("selected")
          ? (b.selectedElements++,
            b.elements.select2.append(
              e.clone(!0).prop("selected", e.data("_selected"))
            ))
          : b.elements.select1.append(
              e.clone(!0).prop("selected", e.data("_selected"))
            );
      }),
      b.settings.showFilterInputs && (l(b, 1), l(b, 2)),
      j(b);
  }
  function l(b, c) {
    if (b.settings.showFilterInputs) {
      ...
      var d = new RegExp(a.trim(b.elements["filterInput" + c].val()), "gi"),
        ...
        f = b.element;
      (f = 1 === c ? e.not(":selected") : f.find("option:selected")),
        f.each(function (f, g) {
          var h = a(g),
            i = !0;
          (g.text.match(d) ||
            (b.settings.filterOnValues && h.attr("value").match(d))) &&
            ((i = !1),
            b.elements["select" + c].append(
              h.clone(!0).prop("selected", h.data("_selected"))
            )),
            e.eq(h.data("original-index")).data("filtered" + c, i);
        }),
        j(b);
    }
  }
  ...
  function o(b) {
    b.find("option")
      .sort(function (b, c) {
        return a(b).data("original-index") > a(c).data("original-index")
          ? 1
          : -1;
      })
      .appendTo(b);
  ...
  function q(b) {
    "all" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect
      ? "moved" !== b.settings.preserveSelectionOnMove ||
        b.settings.moveOnSelect ||
        m(b, 1)
      : (m(b, 1), m(b, 2)),
      b.elements.select1.find("option:selected").each(function (c, d) {
        var e = a(d);
        e.data("filtered1") || h(b, e.data("original-index"), !0);
      }),
      k(b),
      f(b),
      b.settings.sortByInputOrder
        ? n(b.elements.select2)
        : o(b.elements.select2);
  }
  function r(b) {
    "all" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect
      ? "moved" !== b.settings.preserveSelectionOnMove ||
        ...
        m(b, 2)
      : (m(b, 1), m(b, 2)),
      b.elements.select2.find("option:selected").each(function (c, d) {
        var e = a(d);
        e.data("filtered2") || h(b, e.data("original-index"), !1);
      }),
      k(b),
      f(b),
      o(b.elements.select1),
      b.settings.sortByInputOrder && n(b.elements.select2);
  }
  function s(b) {
    "all" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect
      ? "moved" !== b.settings.preserveSelectionOnMove ||
      ...
      b.element.find("option").each(function (c, d) {
        ...
        e.data("filtered1") ||
          (e.prop("selected", !0),
          e.attr("data-sortindex", b.sortIndex),
          b.sortIndex++);
      }),
      k(b),
      f(b);
  ...
  function t(b) {
    "all" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect
      ? "moved" !== b.settings.preserveSelectionOnMove ||
        ...
        m(b, 2)
      : (m(b, 1), m(b, 2)),
      b.element.find("option").each(function (b, c) {
        var d = a(c);
        d.data("filtered2") ||
          (d.prop("selected", !1), d.removeAttr("data-sortindex"));
      }),
      k(b),
      f(b);
  }
  function u(a) {
    a.elements.form.submit(function (b) {
      a.elements.filterInput1.is(":focus")
        ? (b.preventDefault(), a.elements.filterInput1.focusout())
        : a.elements.filterInput2.is(":focus") &&
          (b.preventDefault(), a.elements.filterInput2.focusout());
    }),
      ...
      a.settings.eventMoveOverride === !1 &&
        a.elements.moveButton.on("click", function () {
          q(a);
        }),
      a.settings.eventMoveAllOverride === !1 &&
        a.elements.moveAllButton.on("click", function () {
          s(a);
        }),
      a.settings.eventRemoveOverride === !1 &&
        a.elements.removeButton.on("click", function () {
          r(a);
        }),
      a.settings.eventRemoveAllOverride === !1 &&
  ...
  (e.prototype = {
    init: function () {
      ...
      return (
        this.elements.select1.attr("id", b),
        this.elements.select2.attr("id", c),
        this.elements.label1.attr("for", b),
        this.elements.label2.attr("for", c),
    ...
    setBootstrap2Compatible: function (a, b) {
      return (
        (this.settings.bootstrap2Compatible = a),
        a
          ? (this.container
              .removeClass("row")
            ...
            this.container
              .find(".clear1, .clear2")
              .removeClass("btn-primary btn-xs")
              .addClass("btn-mini"),
            this.container.find("input, select").removeClass("form-control"),
            this.container.find(".btn").removeClass("btn-primary"),
            this.container
          ...
          : (this.container
            ...
            this.container.find(".btn").addClass("btn-primary"),
            this.container
              .find(".moveall > i, .move > i")
    ...
    setFilterTextClear: function (a, b) {
      return (
        (this.settings.filterTextClear = a),
        this.elements.filterClear1.html(a),
        this.elements.filterClear2.html(a),
        b && k(this),
        this.element
      );
    },
    setFilterPlaceHolder: function (a, b) {
      return (
        (this.settings.filterPlaceHolder = a),
        this.elements.filterInput1.attr("placeholder", a),
        this.elements.filterInput2.attr("placeholder", a),
        b && k(this),
        this.element
      );
    },
    setMoveSelectedLabel: function (a, b) {
      return (
        (this.settings.moveSelectedLabel = a),
        this.elements.moveButton.attr("title", a),
        b && k(this),
        this.element
      );
    },
    setMoveAllLabel: function (a, b) {
      return (
        (this.settings.moveAllLabel = a),
        this.elements.moveAllButton.attr("title", a),
        b && k(this),
        this.element
      );
    },
    setRemoveSelectedLabel: function (a, b) {
      return (
        (this.settings.removeSelectedLabel = a),
        this.elements.removeButton.attr("title", a),
        b && k(this),
        this.element
      );
    },
    setRemoveAllLabel: function (a, b) {
      return (
        (this.settings.removeAllLabel = a),
        this.elements.removeAllButton.attr("title", a),
        b && k(this),
        this.element
      );
    },
    ...
    setPreserveSelectionOnMove: function (a, b) {
      return (
        x && (a = !1),
        (this.settings.preserveSelectionOnMove = a),
        b && k(this),
        this.element
      );
    },
    setSelectedListLabel: function (a, b) {
      return (
        (this.settings.selectedListLabel = a),
        a
          ? this.elements.label2.show().html(a)
          : this.elements.label2.hide().html(a),
        b && k(this),
        this.element
      );
    },
    setNonSelectedListLabel: function (a, b) {
      return (
        (this.settings.nonSelectedListLabel = a),
        a
          ? this.elements.label1.show().html(a)
          : this.elements.label1.hide().html(a),
        b && k(this),
        this.element
      );
    },
    setHelperSelectNamePostfix: function (a, b) {
      return (
        (this.settings.helperSelectNamePostfix = a),
        a
          ? (this.elements.select1.attr(
              "name",
              this.originalSelectName + a + "1"
            ),
            this.elements.select2.attr(
              "name",
              this.originalSelectName + a + "2"
            ))
    ...
    setSelectOrMinimalHeight: function (a, b) {
      ...
      return (
        this.element.height() < a && (c = a),
        this.elements.select1.height(c),
        this.elements.select2.height(c),
        b && k(this),
        this.element
      );
    },
    setShowFilterInputs: function (a, b) {
      return (
        ...
        (this.settings.showFilterInputs = a),
        b && k(this),
        this.element
      );
    },
    setNonSelectedFilter: function (a, b) {
      return this.settings.showFilterInputs
        ? ((this.settings.nonSelectedFilter = a),
          this.elements.filterInput1.val(a),
          b && k(this),
          this.element)
        : void 0;
    },
    setSelectedFilter: function (a, b) {
      return this.settings.showFilterInputs
        ? ((this.settings.selectedFilter = a),
          this.elements.filterInput2.val(a),
          b && k(this),
          this.element)
        : void 0;
    },
    ...
    setSortByInputOrder: function (a, b) {
      return (this.settings.sortByInputOrder = a), b && k(this), this.element;
    },
    setEventMoveOverride: function (a, b) {
      return (this.settings.eventMoveOverride = a), b && k(this), this.element;
    },
    setEventMoveAllOverride: function (a, b) {
      return (
        (this.settings.eventMoveAllOverride = a), b && k(this), this.element
      );
    },
    setEventRemoveOverride: function (a, b) {
      return (
        (this.settings.eventRemoveOverride = a), b && k(this), this.element
      );
    },
    setEventRemoveAllOverride: function (a, b) {
      return (
        (this.settings.eventRemoveAllOverride = a), b && k(this), this.element
      );
    },
    ...
    (a.fn[v] = function (b) {
      ...
      if (b === d || "object" == typeof b)
        return this.each(function () {
          a(this).is("select")
            ? a.data(this, "plugin_" + v) ||
              a.data(this, "plugin_" + v, new e(this, b))
            : a(this)
                .find("select")
                .each(function (c, d) {
